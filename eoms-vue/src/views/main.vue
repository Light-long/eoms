		...
		<aside class="site-sidebar site-sidebar--dark">
			<div class="site-sidebar__inner">
				...
				>
					...
					<!--文件管理-->
					<el-menu-item index="file" @click="$router.push({ name: 'Document' })">
						<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-ba633cb8="" class="icon-svg-2">
					...
					>
						...
						>
							<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-ba633cb8="" class="icon-svg-2">
								<path fill="currentColor" d="M128 384v448h768V384H128zm-32-64h832a32 32 0 0 1 32 32v512a32 32 0 0 1-32 32H96a32 32 0 0 1-32-32V352a32 32 0 0 1 32-32zm64-128h704v64H160zm96-128h512v64H256z"></path>
							</svg>
